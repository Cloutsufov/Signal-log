...
`2026-09-26 21:40 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-09-26 17:40 (weekend)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 84184.145 via coinbase (+0.47%)
  ok  ETH-USD: 2686.515 via coinbase (+0.20%)
...
21 feeds alive, 0 dead, 2 new headlines, 35 filtered as off-topic, 0 purged from history
dead: none
