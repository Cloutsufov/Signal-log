...
`2026-08-29 21:21 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-29 17:21 (weekend)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78166.405 via coinbase (+1.03%)
  ok  ETH-USD: 2452.125 via coinbase (+1.12%)
...
21 feeds alive, 0 dead, 19 new headlines, 26 filtered as off-topic, 0 purged from history
dead: none
