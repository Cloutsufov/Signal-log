...
`2026-08-25 05:01 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-25 01:00 (premarket)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 80346.545 via coinbase (+4.13%)
  ok  ETH-USD: 2493.885 via coinbase (+1.82%)
...
19 feeds alive, 2 dead, 6 new headlines, 28 filtered as off-topic, 0 purged from history
...
wrote docs/news.html (42,904 bytes)
