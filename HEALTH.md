...
`2026-09-25 15:37 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-09-25 11:37 (open)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 83718.915 via coinbase (-0.81%)
  ok  ETH-USD: 2684.525 via coinbase (+0.05%)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_news.py
  ...
  ok    BBC Business             51 items, 1 new
  ok    Al Jazeera               3 items, 2 new
  ...
  ok    EIA Today in Energy      19 items, 1 new
  ok    Reuters Business (Google) 0 items, 0 new
  ok    AP Business (Google)     0 items, 0 new

21 feeds alive, 0 dead, 27 new headlines, 35 filtered as off-topic, 0 purged from history
dead: none
