...
`2026-08-24 20:54 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-24 16:54 (postclose)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78855.695 via coinbase (+1.89%)
  ok  ETH-USD: 2472.415 via coinbase (+0.91%)
...
21 feeds alive, 0 dead, 7 new headlines, 28 filtered as off-topic, 0 purged from history
dead: none
