...
`2026-08-25 20:15 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-25 16:15 (postclose)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78855.455 via coinbase (-0.09%)
  ok  ETH-USD: 2457.815 via coinbase (-0.70%)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_news.py
  ...
  ok    CNBC Top News            22 items, 3 new
  ok    CNBC Markets             30 items, 0 new
  ok    MarketWatch              10 items, 2 new
  ok    Yahoo Finance            47 items, 5 new
...
21 feeds alive, 0 dead, 11 new headlines, 24 filtered as off-topic, 0 purged from history
dead: none
