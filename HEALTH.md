...
`2026-08-25 21:49 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-25 17:49 (postclose)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78605.995 via coinbase (-0.46%)
  ok  ETH-USD: 2442.67 via coinbase (-1.65%)
...
21 feeds alive, 0 dead, 12 new headlines, 23 filtered as off-topic, 0 purged from history
dead: none
...
wrote docs/news.html (43,153 bytes)
