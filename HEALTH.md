...
`2026-08-25 22:51 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-25 18:50 (postclose)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78852.155 via coinbase (+0.15%)
  ok  ETH-USD: 2452.95 via coinbase (-0.85%)
...
21 feeds alive, 0 dead, 16 new headlines, 22 filtered as off-topic, 0 purged from history
dead: none
