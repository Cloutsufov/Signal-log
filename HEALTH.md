...
`2026-08-26 05:56 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-26 01:56 (premarket)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78996.485 via coinbase (-2.11%)
  ok  ETH-USD: 2462.585 via coinbase (-1.81%)
...
21 feeds alive, 0 dead, 31 new headlines, 28 filtered as off-topic, 0 purged from history
dead: none
