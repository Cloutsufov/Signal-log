...
`2026-09-09 19:32 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-09-09 15:32 (open)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78517.765 via coinbase (+0.11%)
  ok  ETH-USD: 2481.025 via coinbase (-0.05%)
...
21 feeds alive, 0 dead, 40 new headlines, 29 filtered as off-topic, 0 purged from history
dead: none
