...
`2026-09-18 21:20 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-09-18 17:19 (postclose)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 81108.485 via coinbase (+6.29%)
  ok  ETH-USD: 2632.56 via coinbase (+7.66%)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_news.py
  ...
  ok    CNBC Top News            12 items, 2 new
...
19 feeds alive, 2 dead, 34 new headlines, 39 filtered as off-topic, 0 purged from history
