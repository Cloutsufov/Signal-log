...
`2026-09-11 17:23 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-09-11 13:22 (open)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 77727.905 via coinbase (+0.57%)
  ok  ETH-USD: 2573.055 via coinbase (+4.38%)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_news.py
  ...
  ok    CNBC Top News            24 items, 10 new
...
21 feeds alive, 0 dead, 56 new headlines, 26 filtered as off-topic, 0 purged from history
dead: none
