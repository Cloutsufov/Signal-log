...
`2026-09-10 19:52 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-09-10 15:52 (open)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 77113.845 via coinbase (-1.40%)
  ok  ETH-USD: 2463.865 via coinbase (-0.04%)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_news.py
  ...
  ok    CNBC Top News            20 items, 5 new
...
21 feeds alive, 0 dead, 30 new headlines, 30 filtered as off-topic, 0 purged from history
dead: none
