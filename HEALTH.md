...
`2026-08-29 23:27 UTC` · trigger: `*/30 * * * *`

```
trigger: action=(none) schedule=*/30 * * * *
ET now:  2026-08-29 19:26 (weekend)
plan:    4 step(s)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_market.py --class crypto --symbols BTC-USD,ETH-USD
  ok  BTC-USD: 78194.095 via coinbase (+0.46%)
  ok  ETH-USD: 2453.135 via coinbase (+0.42%)
...
$ /home/runner/work/Signal-log/Signal-log/scripts/fetch_news.py
  ...
  ok    Guardian Business        34 items, 1 new
...
21 feeds alive, 0 dead, 12 new headlines, 25 filtered as off-topic, 0 purged from history
dead: none
